                        ...
                        <div class="card">
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="card-header">
                                    <a href="/payment/{{ $id }}"><button type="submit" class="btn btn-info btn-sm">Back</button></a>
                                    {{ $type=='create' ? 'Create' : 'Update' }} <strong>Payment</strong> {{ $type=='create' ? '' : ' "'.$page['data']->name.'"' }}"
                                </div>
                                    ...
                                    @if($page['created'])
                                        <div>
                                            <div class="alert alert-success alert-margin">
                                                <ul>
                                                    <li>Payment {{ $type=='create' ? 'Created' : 'Updated' }} Successfully</li>
                                                </ul>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input id="price" name="price" type="text" class="form-control valid" data-val="true" data-val-required="Please enter the name on card" aria-required="true" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
